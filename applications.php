...
<?php include 'navbar.php'; ?>
  ...
  <div class="container">
    ...
    <p class="hero-subtitle">Šeit Tu vari apskatīt savus iesniegtos pieteikumus un to statusus</p>
  </div>
</section>
  ...
  <main class="container content-section">
    ...
    <div class="filters-card">
      ...
      <div class="filters">
        ...
        <div class="filter-group">
          <label for="filter-type">Dzīvnieks</label>
  ...
  <footer>
    <div class="container">
      <p>&copy; 2025 SirdsPaws — Palīdzam dzīvniekiem atrast mājvietu ar sirdi ❤️</p>
    </div>
  </footer>
